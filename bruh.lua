...
tl.Size = UDim2.new(.96, 0, .92, 0)
tl.Position = UDim2.new(.02, 0, .095, 0)
...
game:GetService("RunService").Heartbeat:Connect(
    function()
        ...
        tl.Text = table.concat(watermark.text, watermark.separator)
        ...
        bg.Position = UDim2.new(0.017, 0, 0.023, 0)
...
Watermark.InputChanged:Connect(
    function(input)
